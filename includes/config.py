...
workflow_status = os.environ.get("workflow_status") # Dictionary with workflow labels and assoc IDs from Gather Content

nextproject = os.environ.get("nextproject")  # ID integer for next Gather Content project
maxcycles = 1
